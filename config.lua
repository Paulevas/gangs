...
Config.Framework = 3 --[ 1 = ESX / 2 = QBCore / 3 = Other ] Choose your framework
...
Config.ZoneOptions = {
    showHudInfo = true, -- Shows custom hud information in the lower right corner of the screen
...
Config.DrugOptions = {
    ...
    saleAlwaysReport = false, -- If enabled, police will get a dispatch for accepted, rejected and reported.
...
Config.RanksAccess = {
    ...
    ['rivalry.give_up_territory'] = {
        icon = 'fa-trophy',
        label = 'Give up territory',
        description = 'This rank allows the member to give up their loyalty in the zone',
    },
}
    ...
    ranks = {
        ...
        },
        {
            ...
            access = {
                ...
                ['members.kick'] = true,
                ['rivalry.claim'] = true,
                ['rivalry.give_up_territory'] = true,
            },
        },
        {
            label = 'President',
